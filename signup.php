  ...
  <nav class="autohide navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="container">
      <section class="signup_section">
        <form action="signup_user.php" method="post" class="col col-md-4 col-sm-2 mb-4" id="signup_container" onsubmit="return formValidateSignup()">
          <fieldset>
            ...
            <div class="input-group">
              <span class="input-group-text .mt-0" id="basic-addon1"><i class="fa-solid fa-user"></i></span>
            ...
            <div class="input-group">
              <span class="input-group-text .mt-0" id="basic-addon1"><i class="fa-solid fa-envelope"></i></span>
            ...
            <div class="input-group">
              <span class="input-group-text .mt-0" id="basic-addon1"><i class="fa-solid fa-key"></i></span>
            ...
            <div class="input-group">
              <span class="input-group-text .mt-0" id="basic-addon1"><i class="fa-solid fa-circle-check"></i></span>
            ...
            <div class="input-group">
              <span class="input-group-text .mt-0" id="basic-addon1"><i class="fa-solid fa-phone"></i></i></span>
